...
function Login() {
  ...
  return (
    ...
    md:items-center md:justify-center md:bg-transparent">
      ...
      md:max-w-md md:px-14 md:justify-self-center">
          <h1 className="text-4xl font-semibold">Sign In</h1>
          <div className="space-y-4">
              <label className="inline-block w-full">
                  <input type="email" placeholder="Email" className="input" {...register("email", {required: true})} />
                  {errors.email && <p className="p-1 text-[13px] font-[400] text-orange-500">Enter a valid email</p>}
              </label>
              <label className="inline-block w-full">
                  <input type="password" placeholder="Password" className="input" {...register("password", {required: true})}/>
                  {errors.email && <p className="p-1 text-[13px] font-[400] text-orange-500">Enter password</p>}
              </label>
          </div>
          <button 
          type="submit"
        ...
        <div className="text-[gray]">
            New to Netflix? <button className="text-white hover:underline"
